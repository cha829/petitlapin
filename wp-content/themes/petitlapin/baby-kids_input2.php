    ...
    <div class="container">
      <div class="row">
        <div class="col-6 offset-3">
          ...
          <form action = "http://localhost/wordpress/baby-kids-2-confirm/" method = "post">
            <input type="hidden" name="csrf_token" value="<?=$csrf_token?>">
            <div class="form-group">
              <label for="holding_day">開催日</label>
              <input type="text" name="holding_day" required="required" value="2020年2月14日（金）" readonly>
            </div>
            <div class="form-group">
