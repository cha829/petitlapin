    ...
    <div class="container">
      <div class="row">
        <div class="col-6 offset-3">
          ...
          <form action = "http://localhost/wordpress/baby-kids-3-confirm/" method = "post">
            <input type="hidden" name="csrf_token" value="<?=$csrf_token?>">
            <div class="form-group">
              <label for="holding_day">開催日</label>
              <input type="text" name="holding_day" required="required" value="2020年2月26日（水）" readonly>
            </div>
            <div class="form-group">
              <label for="holding_place" >開催場所</label>
              <input type="text" name="holding_place" required="required" value="P-KUN CAFE（足立区千住旭町3-5 駅前会館ビル2F）" readonly>
            </div>
            <div class="form-group">
